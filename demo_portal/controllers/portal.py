...
class DemoPortalController(CustomerPortal):
    def _prepare_portal_layout_values(self):
        values = super(
            DemoPortalController, self
    ...
    def portal_my_demo_model_3_portal_diagrams(
        ...
        **kw,
        ...
        return request.render(
            "demo_portal.portal_my_demo_model_3_portal_diagrams", values
        )
    ...
    def portal_my_demo_model_3_portal_diagram(
        ...
        return request.render(
            "demo_portal.portal_my_demo_model_3_portal_diagram", values
        )
