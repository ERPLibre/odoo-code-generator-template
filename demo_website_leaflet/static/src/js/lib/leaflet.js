 ...
 */
/* Modification
Replace all ' aria-hidden="true"' by ''
 */
!(function (t, e) {
    ...
    (et.extend = function (t) {
        ...
        (et.include = function (t) {
            ...
            return (
                l(this.prototype, t), t.options && ((this.prototype.options = e), this.mergeOptions(t.options)), this
            );
        }),
                    ...
                    if (1 === arguments.length) {
                        ...
                        "function" != typeof e
                            ...
                            : !1 !== (e = this._listens(t, e, i)) &&
                              ((i = n[e]),
                              this._firingCount && ((i.fn = u), (this._events[t] = n = n.slice())),
                              n.splice(e, 1));
            },
            fire: function (t, e, i) {
                if (this.listens(t, i)) {
    ...
    var _t = document.documentElement.style,
        ...
        Ft =
            ...
            "http://www.w3.org/2000/svg" === (Ft.firstChild && Ft.firstChild.namespaceURI));
    function y(t) {
    ...
    var mt = {
        ...
        A = it.extend({
            ...
            _findEventTargets: function (t, e) {
                for (
                    var i, n = [], o = "mouseout" === e || "mouseover" === e, s = t.target || t.srcElement, r = !1;
                    s;
                    ...
                    for (
                        ...
                        if (
                            ...
                            h.originalEvent._stopped ||
                                (!1 === n[s].options.bubblingMouseEvents && -1 !== G(this._mouseEvents, e)))
                        )
                            return;
                }
            },
                ...
                _update: function () {
                    if (this._container) {
                        ...
                        this.options.hideSingleBase &&
                            (this._baseLayersList.style.display = (t = t && 1 < n) ? "" : "none"),
        ...
        Ye = B.extend({
            options: {
                ...
                prefix:
                    ...
                    (b.inlineSvg
                        ? '<svg xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg> '
                        : "") +
                    "Leaflet</a>",
            },
            initialize: function (t) {
            ...
            addAttribution: function (t) {
                return (
                    t &&
                        (this._attributions[t] || (this._attributions[t] = 0), this._attributions[t]++, this._update()),
                    this
                );
            },
            ...
            _update: function () {
                if (this._map) {
                    ...
                    this.options.prefix && i.push(this.options.prefix),
                        ...
                        (this._container.innerHTML = i.join(" <span>|</span> "));
                }
            },
        }),
        n =
            ...
            _onMove: function (t) {
                ...
                this._enabled &&
                    (t.touches && 1 < t.touches.length
                        ? (this._moved = !0)
                        : (!(e = new p(
                              (e = t.touches && 1 === t.touches.length ? t.touches[0] : t).clientX,
                              e.clientY
        ...
        for (s = 0; s < 4; s++) {
            for (h = u[s], n = [], c = 0, o = (d = t.length) - 1; c < d; o = c++)
                (r = t[c]),
                    (a = t[o]),
                    r._code & h
                        ? a._code & h || (((l = ei(a, r, h, e, i))._code = ii(l, e)), n.push(l))
                        : (a._code & h && (((l = ei(a, r, h, e, i))._code = ii(l, e)), n.push(l)), n.push(r));
            t = n;
        }
        return t;
    }
    ...
    var di = ci.extend({
            ...
            _getIconUrl: function (t) {
                return (
                    "string" != typeof di.imagePath && (di.imagePath = this._detectIconPath()),
                    (this.options.imagePath || di.imagePath) + ci.prototype._getIconUrl.call(this, t)
                );
            },
        ...
        _i = n.extend({
            ...
            _onPreDrag: function (t) {
                this._marker.options.autoPan &&
                    (r(this._panRequest), (this._panRequest = x(this._adjustPan.bind(this, t))));
            },
            _onDrag: function (t) {
                var e = this._marker,
                    i = e._shadow,
        ...
        pi = o.extend({
            ...
            update: function () {
                ...
                return (
                    this._icon &&
                        this._map &&
                        ((t = this._map.latLngToLayerPoint(this._latlng).round()), this._setPos(t)),
                    this
                );
            },
            _initIcon: function () {
        ...
        _project: function () {
            ...
            h.distance === st.distance
                ? ((n = Math.PI / 180),
                  ...
                  (n =
                      Math.acos(
                          (Math.cos(o * n) - Math.sin(r * n) * Math.sin(i * n)) / (Math.cos(r * n) * Math.cos(i * n))
                      ) / n),
    ...
    var vi = mi.extend({
        ...
        _updateBounds: function () {
            var t = this._clickTolerance(),
                t = new p(t, t);
            this._rawPxBounds &&
                (this._pxBounds = new f([this._rawPxBounds.min.subtract(t), this._rawPxBounds.max.add(t)]));
        },
                    ...
                    if (1 < Math.abs(i - this._tileZoom)) this._setView(t, i);
                        ...
                        for (var l = o.min.y; l <= o.max.y; l++)
                            for (var u = o.min.x; u <= o.max.x; u++) {
                                ...
                                (d.z = this._tileZoom),
                                    this._isValidTile(d) &&
                                        ((c = this._tiles[this._tileCoordsToKey(d)]) ? (c.current = !0) : r.push(d));
                            }
                        if (
                            (r.sort(function (t, e) {
    ...
    var ji = Ni.extend({
        ...
        getTileUrl: function (t) {
            ...
            return (
                i + U(this.wmsParams, i, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + e
            );
        },
    ...
    var Hi = o.extend({
            ...
            onAdd: function () {
                this._container ||
                    (this._initContainer(), this._zoomAnimated && M(this._container, "leaflet-zoom-animated")),
                    this.getPane().appendChild(this._container),
                    this._update(),
