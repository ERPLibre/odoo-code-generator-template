...
MODULE_NAME = "code_generator_demo_website_multiple_snippet"


def post_init_hook(env):
    # The path of the actual file
    path_module_generate = "addons/TechnoLibre_odoo-code-generator-template"
    ...
    # Add dependencies
    lst_depend_module = ["code_generator"]
