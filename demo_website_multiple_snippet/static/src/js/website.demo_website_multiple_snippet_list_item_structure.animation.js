odoo.define("demo_website_multiple_snippet_list_item_structure.animation", function (require) {
    "use strict";

    let sAnimation = require("website.content.snippets.animation");

    sAnimation.registry.demo_website_multiple_snippet_list_item_structure = sAnimation.Class.extend({
        selector: ".o_demo_website_multiple_snippet_list_item_structure",
