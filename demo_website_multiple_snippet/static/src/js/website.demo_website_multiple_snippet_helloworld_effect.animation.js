odoo.define("demo_website_multiple_snippet_helloworld_effect.animation", function (require) {
    "use strict";

    let sAnimation = require("website.content.snippets.animation");

    sAnimation.registry.demo_website_multiple_snippet_helloworld_effect = sAnimation.Class.extend({
